...
int my_pushd(char **args, char **dirstack)
{
    ...
    {
        perror("pushd failed : directory does not exist");
        return 3;
    }
    return 1;
}
...
int my_popd(char **args, char **dirstack)
{
    ...
    if (counter == 0)
    {
        printf("popd failed : stack has no directory paths in it\n");
        return 3;
    }
...
int my_exclaexcla(char **args, char **dirstack, char **history, char **aliaslist)
{
    ...
    if (args[1] != NULL)
    {
        fprintf(stderr, "unrequired argument to \"!!\"\n");
        return 3;
    }
    if (histcount < 0)
    {
        printf("!! failed : no commands in history\n");
        return 3;
    }
...
int my_exclastring(char **args, char **dirstack, char **history, char **aliaslist)
{
    ...
    if (args[1] != NULL)
    {
        fprintf(stderr, "unrequired argument to \"!string\"\n");
        return 3;
    }
    if (histcount < 0 || str == NULL)
    {
        printf("!%s failed : no commands in history\n", str);
        return 3;
    }
...
int my_exclan(char **args, char **dirstack, char **history, char **aliaslist)
{
    ...
    if (args[1] != NULL)
    {
        fprintf(stderr, "unrequired argument to \"!n\"\n");
        return 3;
    }
    if (histcount < 0)
    {
        printf("!n failed : no commands in history\n");
        return 3;
    }
...
int my_alias(char **args, char **aliaslist)
{
    ...
    {
        fprintf(stderr, "enter exactly 0 or 2 arguments for \"alias\"\n");
        return 3;
    }
    return 1;
}
...
int my_mkdir(char **args)
{
    ...
    while ((c = getopt(argc, args, "m:p:")) != -1)
    {
        ...
        case 'p':
            ...
            break;
        default:
            fprintf(stderr, "expected -m or -p options only for \"%s\"\n", args[0]);
            return 3;
            return 1;
            break;
        }
    ...
    for (i = 0; i < (sizeof(stdcommands) / sizeof(char *)); i++)
    {
        if (strcmp(args[0], stdcommands[i]) == 0)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                return my_pushd(args, dirstack);
                break;
            case 4:
                return my_popd(args, dirstack);
                break;
            case 5:
                return my_dirs(args, dirstack);
                break;
            case 6:
                return my_history(args, history);
                break;
            case 7:
                return my_exclaexcla(args, dirstack, history, aliaslist);
                break;
            case 8:
                return 1;
                break;
            ...
            case 10:
                ...
                break;
            case 11:
                return my_alias(args, aliaslist);
                break;
            case 12:
                return my_unalias(args, aliaslist);
                break;
            case 13:
